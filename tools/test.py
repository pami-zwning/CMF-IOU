...
def parse_config():
    ...
    parser.add_argument('--ckpt', type=str, default="/home/ubuntu/zwning/TED/output/models/kitti/VirConv-T_Res/default/ckpt/checkpoint_epoch_30.pth", help='checkpoint to start from')
